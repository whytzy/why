...
tnggl=$(date +"%d-%B-%Y")
echo -e ""
echo -e "${RED}>> informasi Virtual Private Server ${NC} "
echo -e "Waktu              : $jam"
echo -e "Hari                  : $hari"
...
echo -e ""
echo -e "${RED}>> Menu SSH Websocket & OpenVPN ${NC} "
echo -e ""
...
echo -e ""
echo -e "${RED}>> Menu V2ray / Vmess ${NC}"
echo -e ""
...
echo -e ""
echo -e "${RED}>> Menu V2ray / Vless ${NC}"
echo -e ""
...
echo -e ""
echo -e "${RED}>> Informasi System / Develover ${NC}"
echo -e ""
