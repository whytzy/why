...
echo -e ""
echo -e "${RED} __      __.__            _________ __                         ${NC}"
echo -e "${CYANN}/  \    /  \  |__ ___.__./   _____//  |_  ___________   ____   ${NC}"
echo -e "${RED}\   \/\/   /  |  <   |  |\_____  \\   __\/  _ \_  __ \_/ __ \  ${NC}"
echo -e "${BLUE} \        /|   Y  \___  |/        \|  | (  <_> )  | \/\  ___/  ${NC}"
echo -e "${RED}  \__/\  / |___|  / ____/_______  /|__|  \____/|__|    \___  > ${NC}"
echo -e "${PURPLE}       \/       \/\/            \/                         \/  ${NC}"
echo -e ""
# Echoing Result
echo -e "---------------------------------------------------------------------"
